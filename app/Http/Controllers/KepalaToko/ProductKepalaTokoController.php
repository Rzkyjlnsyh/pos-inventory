...
class ProductKepalaTokoController extends Controller implements FromArray, WithHeadings
{
    public function index(Request $request): View
    {
        ...
        return view('kepala-toko.product.index', compact('products', 'categories', 'q', 'categoryId'));
    }

    public function create(): View
    {
        $categories = Category::orderBy('name')->get();
        return view('kepala-toko.product.create', compact('categories'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('kepala-toko.product.index')->with('success', 'Produk berhasil ditambahkan');
    }

    public function show(Product $product): View
    {
        $categories = Category::orderBy('name')->get();
        return view('kepala-toko.product.show', compact('product', 'categories'));
    }

    public function edit(Product $product): View
    {
        $categories = Category::orderBy('name')->get();
        return view('kepala-toko.product.edit', compact('product', 'categories'));
    }
    ...
    public function update(Request $request, Product $product): RedirectResponse
    {
        ...
        return redirect()->route('kepala-toko.product.index')->with('success', 'Produk berhasil diperbarui');
    }
    ...
    public function destroy(Product $product): RedirectResponse
    {
        ...
        $product->delete();
        return redirect()->route('kepala-toko.product.index')->with('success', 'Produk berhasil dihapus');
    }
