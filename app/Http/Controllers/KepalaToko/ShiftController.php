...
class ShiftController extends Controller
{
    public function start(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('kepala-toko.shift.dashboard')->with('success', 'Shift dimulai dengan kas awal Rp ' . number_format($validated['initial_cash'], 0, ',', '.'));
    }
    ...
    public function end(Request $request): RedirectResponse
    {
        ...
        // Redirect ke HISTORY SHIFT kepala, bukan owner
        return redirect()->route('kepala-toko.shift.history')->with('success', 'Shift diakhiri. Kas diharapkan: Rp ' . number_format($expectedCash, 0, ',', '.') . ', Selisih: Rp ' . number_format($discrepancy, 0, ',', '.'));
    }
    ...
    public function dashboard(): View
    {
        ...
        if ($shift) {
            ...
            $tunaiDiLaci = $shift->initial_cash + $totalCashFromPayments - $shift->expense_total;
            $totalDiharapkan = $shift->initial_cash + $totalCashFromPayments - $shift->expense_total;
        }

        // Render view kepala, bukan owner
    ...
    /**
     * Riwayat Shift untuk kepala
     * HANYA menampilkan list history, tidak bisa lihat detail atau export
     */

    /**
     * Riwayat Shift untuk Kepala Toko
     * Bisa lihat SEMUA shift di toko, bukan hanya miliknya
     */
    public function history(): View
    {
        // Bedanya: Tampilkan SEMUA shift, bukan hanya milik user ini
    ...
    /**
     * Detail Shift untuk Kepala Toko
     * Bisa lihat detail shift mana saja
     */
    public function show(Shift $shift): View
    {
        ...
        return view('kepala-toko.shift.show', compact('shift', 'salesOrders', 'expenses', 'incomes'));
    }

    /**
     * Export Excel untuk Kepala Toko
     */
    ...
    /**
     * Export Detail Excel untuk Kepala Toko
     */
