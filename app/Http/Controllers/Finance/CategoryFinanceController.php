...
class CategoryFinanceController extends Controller implements FromArray, WithHeadings
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('finance.categories.index', compact('categories', 'q'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('finance.category.index')->with('success', 'Category created');
    }
    ...
    public function update(Request $request, Category $category): RedirectResponse
    {
        ...
        return redirect()->route('finance.category.index')->with('success', 'Category updated');
    }

    public function destroy(Category $category): RedirectResponse
    {
        $category->delete();
        return redirect()->route('finance.category.index')->with('success', 'Category deleted');
    }

    public function importForm(): View
    {
        return view('finance.categories.import');
    }
    ...
    public function import(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('finance.category.index')->with('success', 'Kategori berhasil diimport');
    }
