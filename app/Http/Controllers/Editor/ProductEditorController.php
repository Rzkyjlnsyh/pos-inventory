...
class ProductEditorController extends Controller implements FromArray, WithHeadings
{
    ...
    {
        $categories = Category::orderBy('name')->get();
        return view('editor.product.create', compact('categories'));
    }
    ...
    {
        $categories = Category::orderBy('name')->get();
        return view('editor.product.show', compact('product', 'categories'));
    }

    public function edit(Product $product): View
    {
        $categories = Category::orderBy('name')->get();
        return view('editor.product.edit', compact('product', 'categories'));
    }
    ...
    public function import(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('editor.product.index')->with('success', $message);
