                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <form method="GET" action="{{ route('admin.product.index') }}" class="row g-3 mb-4">
                                    <div class="col-md-8">
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <button type="button" class="btn btn-outline-danger" 
                                                                    title="Hapus"
                                                                    onclick="confirmDelete('{{ route('admin.product.destroy', $product) }}', '{{ $product->name }}')">
                        ...
                        <div class="alert alert-info">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('admin.product.download-template') }}" class="btn btn-sm btn-outline-primary">
