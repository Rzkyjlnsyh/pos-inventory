    ...
    <div class="flex-1 lg:w-5/6">
        ...
        <div class="p-4 lg:p-8">
            <div class="bg-white p-6 rounded-xl shadow-lg mb-6">
                <h1 class="text-2xl font-semibold text-gray-800 mb-4">Riwayat Shift Saya</h1>
                <div class="mb-4">
                    <a href="{{ route('admin.shift.dashboard') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded shadow inline-block">
                        <i class="bi bi-arrow-left"></i> Kembali ke Dashboard Shift
                    </a>
                </div>
