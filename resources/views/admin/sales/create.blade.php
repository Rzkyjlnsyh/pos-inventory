        ...
        <div class="flex-1 lg:w-5/6">
            ...
            <div class="p-4 lg:p-8">
                <div class="bg-white p-6 rounded-xl shadow-lg mb-6">
                    ...
                    @endif
                    <form action="{{ route('admin.sales.store') }}" method="POST" id="soForm"
                        ...
                        <div class="grid md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div id="supplier-section" class="hidden mt-4">
                                <label for="supplier_search" class="block font-medium mb-1">Supplier untuk Pembelian
                                    *</label>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                ...
                                <div id="proof-field" class="mt-4 hidden md:col-span-2">
                                    <label for="proof_path" class="block font-medium mb-1">Bukti Transfer (jpg, png,
                                        pdf, opsional)</label>
