        ...
        <div class="bg-white p-6 rounded-xl shadow-lg">
          ...
          <nav class="mb-4 flex bg-gray-100 p-3 rounded-lg">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-sm">
              <li>
                <a href="{{ route('admin.dashboard') }}" class="text-gray-700 hover:text-[#005281] flex items-center">
                  <i class="bi bi-house-door mr-1"></i> Dashboard
                </a>
              </li>
              <li>
                <span class="text-gray-400 mx-1">/</span>
                <a href="{{ route('admin.inventory.index') }}" class="text-gray-700 hover:text-[#005281]">Inventory</a>
              </li>
              <li>
                <span class="text-gray-400 mx-1">/</span>
          ...
          <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex space-x-2">
              <a href="{{ route('admin.inventory.stock-opnames.template') }}"
              ...
              <a href="{{ route('admin.inventory.stock-opnames.create') }}"
          ...
          <div id="importModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
              ...
              <form action="{{ route('admin.inventory.stock-opnames.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
            ...
            <table class="min-w-full border rounded-lg">
              ...
              <tbody>
                @forelse($stockOpnames as $opname)
                  <tr class="border-b clickable-row hover:bg-gray-50" onclick="window.location='{{ route('admin.inventory.stock-opnames.show', $opname->id) }}'">
