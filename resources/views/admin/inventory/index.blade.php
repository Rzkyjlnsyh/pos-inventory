...
<body class="bg-gray-100">
  <div class="flex">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg">
          <div class="flex border-b mb-4">
            <a href="{{ route('admin.inventory.index') }}" 
               class="px-4 py-2 font-semibold {{ request()->routeIs('admin.inventory.index') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">
              Overview
            </a>
            <a href="{{ route('admin.inventory.stock-ins.index') }}" 
               class="px-4 py-2 font-semibold {{ request()->routeIs('admin.inventory.stock-ins.*') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">
              Stok Masuk
            </a>
            <a href="{{ route('admin.inventory.stock-opnames.index') }}" 
               class="px-4 py-2 font-semibold {{ request()->routeIs('admin.inventory.stock-opnames.*') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">
              Stock Opname
            </a>
            <a href="{{ route('admin.inventory.stock-movements.index') }}" 
               class="px-4 py-2 font-semibold {{ request()->routeIs('admin.inventory.stock-movements.*') ? 'border-b-2 border-[#005281] text-[#005281]' : 'text-gray-500 hover:text-[#005281] hover:border-b-2 hover:border-gray-300' }}">
              Pergerakan Stok
            </a>
          </div>
        ...
        <div class="bg-blue-50 p-4 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.product.index') }}" class="text-xs text-blue-600 hover:underline">Lihat Produk</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-green-50 p-4 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.inventory.stock-ins.index') }}" class="text-xs text-green-600 hover:underline">Lihat Detail</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-yellow-50 p-4 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.inventory.stock-opnames.index') }}" class="text-xs text-yellow-600 hover:underline">Lihat Opname</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-red-50 p-4 rounded-lg shadow">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.product.index') }}" class="text-xs text-red-600 hover:underline">Lihat Produk</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-6">
        ...
        <div class="mt-3">
            <a href="{{ route('admin.inventory.stock-movements.index') }}" class="text-blue-600 hover:underline text-sm">Lihat Semua Pergerakan</a>
        </div>
    </div>
@endif
        </div>
