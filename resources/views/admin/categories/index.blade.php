...
<html lang="en">
  ...
  <body class="bg-gray-100">
    ...
    <div class="flex space-x-2">
        <a href="{{ route('admin.category.import') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
            <i class="bi bi-upload mr-1"></i>Import
        </a>
        <a href="{{ route('admin.category.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
