          ...
          <div class="p-6 bg-gray-100 min-h-screen">
              <div class="max-w-3xl mx-auto">
                  <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.category.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">
                  ...
                  <div class="bg-white rounded-lg shadow overflow-hidden">
                      <div class="p-6">
                        <form method="POST" action="{{ route('admin.category.update', $category) }}" class="space-y-6">
                            @csrf
                            @method('PUT')
