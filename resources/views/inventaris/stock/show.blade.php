...
<head>
    ...
    <title>Detail Stok - Pare Custom</title>
                    ...
                    <nav class="flex mb-8" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            <li class="inline-flex items-center">
                                <a href="{{ route('inventaris.stock.index') }}" class="inline-flex items-center text-gray-500">
                        ...
                        <div class="p-8">
                            ...
                            <div class="flex flex-col md:flex-row gap-4 items-center justify-between border-t pt-6">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('inventaris.stock.index') }}" 
                                    ...
                                    <form action="{{ route('inventaris.stock.destroy', $stock) }}" 
                                          method="POST" 
                                          class="inline" 
