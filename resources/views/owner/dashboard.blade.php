            ...
            <div class="flex items-center gap-6 relative">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-gray-600 text-sm">
                        Selamat datang di dashboard Owner untuk manajemen sistem dan Monitoring.
                    </p>
                </div>
            </div>
          </div>
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-purple-700 mt-1">
                  Fitur Owner sedang dalam tahap pengembangan. Sistem role berhasil diimplementasi!
                </p>
              </div>
            </div>
          </div>
