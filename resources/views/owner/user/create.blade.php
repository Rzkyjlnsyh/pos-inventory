...
<head>
    ...
    <title>Tambah Pengguna - Pare Custom</title>
...
<body class="bg-gray-100">
                ...
                <div class="p-4 lg:p-6 bg-gray-100 min-h-screen">
                    <div class="max-w-2xl mx-auto">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-3 bg-transparent px-4 py-2 rounded-lg">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-1 text-sm font-medium text-indigo-600">Tambah Pengguna</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        ...
                        <div class="mb-6 bg-white rounded-lg p-5 shadow-sm border-l-4 border-indigo-500">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 mt-1">Isi formulir berikut untuk menambahkan pengguna baru ke sistem</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl overflow-hidden form-card">
                            ...
                            <div class="p-6">
                                <form action="{{ route('owner.user.store') }}" method="POST" id="userForm">
                                    @csrf
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            <p class="form-hint"><i class="bi bi-lightbulb text-amber-500 mr-1"></i> Email ini akan digunakan sebagai username untuk login</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="password" name="password" id="password" class="pl-10 focus:ring-2 focus:ring-indigo-200" 
                                                       placeholder="Minimal 8 karakter" required onkeyup="checkPasswordStrength()">
                                            ...
                                            <div class="bg-blue-50 p-3 rounded-lg mt-3 border-l-4 border-blue-400">
                                                <h4 class="text-sm font-semibold text-blue-800 mb-1">Ketentuan Password</h4>
                                                <ul class="text-xs text-blue-700 space-y-1 ml-5 list-disc">
                                                    <li>Minimal 8 karakter</li>
                                                    <li>Sebaiknya gunakan kombinasi huruf kecil dan besar</li>
                                                    <li>Tambahkan minimal 1 angka</li>
                                                    <li>Tambahkan minimal 1 karakter khusus (!@#$%^&*)</li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="password" name="password_confirmation" id="password_confirmation" class="pl-10 focus:ring-2 focus:ring-indigo-200" 
                                                       placeholder="Masukkan kembali password" required onkeyup="checkPasswordMatch()">
                                    ...
                                    <div class="flex flex-col sm:flex-row justify-end gap-3 mt-8">
                                        ...
                                        <button type="submit" class="btn btn-primary order-1 sm:order-2" id="submitBtn">
                                            <i class="bi bi-check2 mr-2"></i> Simpan Pengguna
                                        </button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <!-- Form guide -->
                        <div class="mt-6 bg-white rounded-lg p-5 shadow-sm border border-gray-200">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <ul class="mt-2 text-sm text-gray-600 space-y-1">
                                        <li><i class="bi bi-check2 text-green-500 mr-1"></i> Pastikan semua informasi diisi dengan benar</li>
                                        <li><i class="bi bi-check2 text-green-500 mr-1"></i> Email harus valid dan belum terdaftar sebelumnya</li>
                                        <li><i class="bi bi-check2 text-green-500 mr-1"></i> Password sebaiknya kompleks untuk keamanan</li>
                                        <li><i class="bi bi-check2 text-green-500 mr-1"></i> Tipe pengguna menentukan hak akses dalam sistem</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Pre-select usertype if it exists in old input
            const savedUsertype = "{{ old('usertype') }}";
            if (savedUsertype) {
                const userTypeCard = document.querySelector(`.user-type-card input[value="${savedUsertype}"]`).closest('.user-type-card');
                if (userTypeCard) {
