                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <a href="{{ route('owner.product.create') }}" class="btn btn-primary">
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <form method="GET" action="{{ route('owner.product.index') }}" class="row g-3 mb-4">
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('owner.product.index') }}" class="btn btn-outline-secondary">
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <button type="button" class="btn btn-outline-danger" 
                                                                    title="Hapus"
                                                                    onclick="confirmDelete('{{ route('owner.product.destroy', $product) }}', '{{ $product->name }}')">
    ...
    <div class="modal fade" id="importModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('owner.product.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                    @csrf
                        ...
                        <div class="alert alert-info">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('owner.product.download-template') }}" class="btn btn-sm btn-outline-primary">
