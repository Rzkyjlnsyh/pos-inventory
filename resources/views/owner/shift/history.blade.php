                    ...
                    <table class="w-full table-auto border-collapse">
                        <thead class="bg-gray-200">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-right">Kas Penjualan</th>
                                <th class="px-4 py-3 text-right">Pemasukan Manual</th>
                                <th class="px-4 py-3 text-right">Total Kas</th>
                        ...
                        <tbody>
                            @foreach ($shifts as $shift)
                                ...
                                <tr class="hover:bg-gray-50 border-b cursor-pointer" onclick="window.location='{{ route('owner.shift.show', $shift) }}'">
                                    ...
                                    <td class="px-4 py-3 text-right text-green-600">Rp {{ number_format($kasPenjualan, 0, ',', '.') }}</td>
                                    <td class="px-4 py-3 text-right text-blue-600">Rp {{ number_format($shift->income_total, 0, ',', '.') }}</td>
                                    <td class="px-4 py-3 text-right font-medium">Rp {{ number_format($shift->cash_total, 0, ',', '.') }}</td>
