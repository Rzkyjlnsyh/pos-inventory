            ...
            <div class="p-6">
                <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('kepala-toko.purchase-returns.index') }}" class="text-gray-500 hover:text-gray-700">
    ...
    <div class="space-y-2">
        ...
        <p><strong>Restock:</strong> {{ $purchaseReturn->restock ? 'Ya' : 'Tidak' }}</p>
                    ...
                    <div class="flex space-x-3">
                        <form action="{{ route('kepala-toko.purchase-returns.confirm', $purchaseReturn) }}" method="POST">
                            @csrf
                            <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700">
                                Konfirmasi Retur
                            </button>
                        </form>
                        <form action="{{ route('kepala-toko.purchase-returns.cancel', $purchaseReturn) }}" method="POST">
                            @csrf
