            ...
            <div class="p-4 lg:p-8">
                <div class="bg-white p-6 rounded-xl shadow-lg mb-6">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('kepala-toko.purchases.index') }}" class="px-4 py-2 border rounded">Kembali</a>
                    </div>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-lg">
                    <form method="POST" action="{{ route('kepala-toko.purchases.store') }}">
                        @csrf
                        ...
                        <div class="pt-4 flex justify-end gap-2">
                            ...
                            <a href="{{ route('kepala-toko.purchases.index') }}" class="px-4 py-2 rounded border">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
