        ...
        <div class="p-4 lg:p-8">
            <div class="bg-white p-6 rounded-xl shadow-lg">
                ...
                <div class="flex flex-wrap gap-4 mb-6">
                    ...
                    <a href="{{ route('kepala-toko.shift.export-detail-pdf', $shift) }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded shadow inline-flex items-center">
