...
<html lang="en">
  ...
  <body class="bg-gray-100">
    ...
    <div class="flex space-x-2">
        <a href="{{ route('kepala-toko.category.import') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
            <i class="bi bi-upload mr-1"></i>Import
        </a>
        <a href="{{ route('kepala-toko.category.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
                                  ...
                                  @foreach($categories as $category)
                                      <tr>
                                          ...
                                          <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex space-x-2">
                                                {{-- Button Edit --}}
                                                <a href="{{ route('kepala-toko.category.edit', $category) }}" 
                                                ...
                                                {{-- Button Hapus --}}
                                                <form action="{{ route('kepala-toko.category.destroy', $category) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
