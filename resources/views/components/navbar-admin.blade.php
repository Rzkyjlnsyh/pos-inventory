    ...
    <div class="flex-1 p-4">
        ...
        <div>
            ...
            <div class="dropdown-menu space-y-2 overflow-hidden max-h-0 transition-all duration-300">
                <a href="{{ route('admin.product.index') }}" class="block p-3 rounded-md bg-none transition mt-2 hover-link">
                    <span class="nav-text font-semibold">Produk</span>
                </a>
                <a href="{{ route('admin.category.index') }}" class="block p-3 rounded-md bg-none transition mt-2 hover-link">
        ...
        <!-- Customer & Supplier -->
        <a href="{{ route('admin.contacts.index') }}" class="flex items-center p-3 rounded-md bg-none transition hover-link">
            <i class="bi bi-people-fill"></i>
            <span class="ml-3 nav-text font-semibold">Customer & Supplier</span>
        </a>

        <!-- Inventory -->
        <a href="{{ route('admin.inventory.index') }}" class="flex items-center p-3 rounded-md bg-none transition hover-link">
      ...
      <div class="dropdown-menu space-y-2 overflow-hidden max-h-0 transition-all duration-300">
        <a href="{{ route('admin.purchases.index') }}" class="block p-3 rounded-md bg-none transition mt-2 hover-link">
