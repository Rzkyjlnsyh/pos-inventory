<div
  ...
  <div class=" flex-1 p-4">
    ...
    <a href="#" class="flex items-center p-3 rounded-md bg-none transition hover-link">
      ...
      <span class="ml-3 nav-text font-semibold">Kelola Staff</span>
    </a>
    ...
    <div>
      <button
        ...
        <span class="flex items-center">
          ...
          <span class="ml-3 nav-text font-semibold">Approval</span>
        </span>
      ...
      <div class="dropdown-menu space-y-2 overflow-hidden max-h-0 transition-all duration-300">
        <a href="#" class="block p-3 rounded-md bg-none transition mt-2 hover-link">
          <span class="nav-text font-semibold">Stock Opname</span>
        </a>
        <a href="#" class="block p-3 rounded-md bg-none transition hover-link">
          <span class="nav-text font-semibold">Purchase Orders</span>
        </a>
      </div>
    </div>
    ...
    <a href="#" class="flex items-center p-3 rounded-md bg-none transition hover-link">
      ...
      <span class="ml-3 nav-text font-semibold">Laporan Performa</span>
    </a>

    <!-- Daily Operations -->
    <a href="#" class="flex items-center p-3 rounded-md bg-none transition hover-link">
      <i class="bi bi-calendar-check"></i>
      <span class="ml-3 nav-text font-semibold">Operasional Harian</span>
    </a>
