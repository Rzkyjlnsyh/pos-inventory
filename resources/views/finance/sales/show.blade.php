            ...
            <div class="bg-white p-6 rounded-xl shadow-lg mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        ...
                        @endif
                        @if(($salesOrder->order_type === 'jahit_sendiri' && $salesOrder->status === 'jadi') || ($salesOrder->order_type === 'beli_jadi' && $salesOrder->status === 'di proses') && $activeShift && Auth::user()->hasRole('finance'))
    ...
    <div class="overflow-x-auto">
        <table class="w-full table-auto border-collapse">
                ...
                @forelse($salesOrder->payments as $payment)
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 border">
                            ...
                            @elseif(in_array($payment->method, ['transfer', 'split']) && $activeShift && Auth::user()->hasRole('finance'))
                                <br>
                                <form action="{{ route('finance.sales.uploadProof', ['salesOrder' => $salesOrder, 'payment' => $payment]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
            ...
            <i class="bi bi-printer"></i>
                                ...
                                <a href="{{ route('finance.sales.printNota', $payment) }}" class="text-blue-600 hover:underline" title="Download PDF">
