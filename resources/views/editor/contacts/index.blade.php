                        ...
                        <div class="bg-white rounded-lg shadow overflow-hidden" x-data="{ tab: 'customers' }">
                            ...
                            <div x-show="tab==='customers'" class="p-6">
                                ...
                                <div class="bg-gray-50 p-6 rounded-lg mb-6">
                                    ...
                                    <div class="flex items-center mb-4">
                                        <a href="{{ route('editor.contacts.customers.template') }}"
                                    ...
                                    <form method="POST" action="{{ route('editor.contacts.customers.import') }}" enctype="multipart/form-data" class="space-y-4">
                                        @csrf
                                ...
                                <div class="bg-gray-50 p-6 rounded-lg mb-6">
                                    ...
                                    <form method="POST" action="{{ route('editor.contacts.customers.store') }}" class="space-y-4">
                                        @csrf
                            ...
                            <div x-show="tab='suppliers'" class="p-6">
                                ...
                                <div class="bg-gray-50 p-6 rounded-lg mb-6">
                                    ...
                                    <div class="flex items-center mb-4">
                                        <a href="{{ route('editor.contacts.suppliers.template') }}"
                                           class="bg-green-500 hover:bg-green-600 text-white px-4 py-2.5 rounded-lg font-medium transition-all duration-200">
                                            <i class="bi bi-download mr-2"></i>Unduh Template Pemasok
                                        </a>
                                    </div>
                                    <form method="POST" action="{{ route('editor.contacts.suppliers.import') }}" enctype="multipart/form-data" class="space-y-4">
                                        @csrf
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-2">Unggah File Excel/CSV *</label>
                                ...
                                <div class="bg-gray-50 p-6 rounded-lg mb-6">
                                    ...
                                    <form method="POST" action="{{ route('editor.contacts.suppliers.store') }}" class="space-y-4">
                                        @csrf
