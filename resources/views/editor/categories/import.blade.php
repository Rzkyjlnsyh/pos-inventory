            ...
            <div class="max-w-7xl mx-auto">
              <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2">
                  <a href="{{ route('editor.category.download-template') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg">
                    <i class="bi bi-download mr-1"></i>Unduh Template Excel
                  </a>
                  <a href="{{ route('editor.category.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
              ...
              <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="p-6">
                  <form action="{{ route('editor.category.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6">
