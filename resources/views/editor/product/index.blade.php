                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <a href="{{ route('editor.product.create') }}" class="btn btn-primary">
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <form method="GET" action="{{ route('editor.product.index') }}" class="row g-3 mb-4">
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('editor.product.index') }}" class="btn btn-outline-secondary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="{{ route('editor.product.show', $product) }}" 
                                                               class="btn btn-outline-info" title="Analisis">
                                                                <i class="bi bi-eye"></i>
                                                            </a>
                                                            <a href="{{ route('editor.product.edit', $product) }}" 
                                                               class="btn btn-outline-warning" title="Edit">
                                                                <i class="bi bi-pencil"></i>
                                                            </a>
                                                            <button type="button" class="btn btn-outline-danger" 
                                                                    title="Hapus"
                                                                    onclick="confirmDelete('{{ route('editor.product.destroy', $product) }}', '{{ $product->name }}')">
    ...
    <div class="modal fade" id="importModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('editor.product.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                    @csrf
                        ...
                        <div class="alert alert-info">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('editor.product.download-template') }}" class="btn btn-sm btn-outline-primary">
